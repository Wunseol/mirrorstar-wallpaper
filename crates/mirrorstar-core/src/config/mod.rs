...
pub use manager::{
    data_root, init_data_root, resolve_data_root, resolve_pool, ConfigKind, ConfigLoadError,
    ConfigManager, DisplayInfo, Pool, WallpaperEntry, WallpaperLibrary, WallpaperMetadata,
};
