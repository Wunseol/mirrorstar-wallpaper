[← 返回文档索引](../index.md) > [技术栈](./01-技术栈总览-Tech-Stack-Overview.md) > 基础设施
...
> 完整 IPC 协议定义见 [进程架构 — IPC 通信设计](../02-架构设计/04-进程架构-Process-Architecture.md)。
...
**相关章节：** [← 总览](./01-技术栈总览-Tech-Stack-Overview.md) | [壁纸渲染](./04-壁纸渲染-Wallpaper-Rendering.md) | [风险评估](./06-风险评估-Risk-Assessment.md)