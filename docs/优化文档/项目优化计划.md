...
10. **架构文档同步**：module-design.md、dependency-graph.md、pause-resume.md、system-architecture.md、quality.md 中 lib.rs 行数、系统托盘位置（→state.rs）、全屏检测位置（→platform/fullscreen.rs）、wp-proc 行数等全部更正。
